  ...
  return (
    <article className="max-w-containerSmall mx-auto">
      ...
      <section className="flex flex-col max-w-containerxs mx-auto">
        ...
        <h3 className="font-semibold text-start mb-3">Connect</h3>
        <div>
          <p className="mb-1 text-[14px]">
            <a
              className="underline duration-200"
              href="mailto:jvp.2703@gmail.com"
            >
              jvp_2703@gmail.com
            </a>
          </p>
          <p className="mb-1 text-[14px]">+34 645058243</p>
          <p className="text-[14px]">Las Palmas de G.C, Spain</p>
        </div>
        <Divider className="my-8"/>
        <h3 className="font-semibold text-start mb-3">
